...
class Generator():
    ...
    def generate_cond(self):
        cond=pd.read_csv("./data2/features/preproc_diag.csv.gz", compression='gzip', header=0, index_col=None)
    ...
    def generate_proc(self):
        proc=pd.read_csv("./data2/features/preproc_proc.csv.gz", compression='gzip', header=0, index_col=None)
    ...
    def generate_labs(self):
        chunksize = 10000000
        final=pd.DataFrame()
        for labs in tqdm(pd.read_csv("./data2/features/preproc_labs.csv.gz", compression='gzip', header=0, index_col=None,chunksize=chunksize)):
    ...
    def generate_meds(self):
        meds=pd.read_csv("./data2/features/preproc_med.csv.gz", compression='gzip', header=0, index_col=None)
    ...
    def create_Dict(self,meds,proc,labs,los):
        ...
        if(self.feat_lab):    
            with open("./data2/dict/labsVocab", 'wb') as fp:
