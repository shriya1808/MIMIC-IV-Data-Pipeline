...
def create_vocab(file):
    with open ('./dataCOPD/dict/'+file, 'rb') as fp:
...
def create_batches(batch_size,chart_flag):
    with open ('./dataCOPD/dict/'+'hadmDic', 'rb') as fp:
        hids = pickle.load(fp)
    
    batchDict={}
    with open ('./dataCOPD/dict/'+'dataDic', 'rb') as fp:
        dataDic = pickle.load(fp)
    if chart_flag:
        batchChartDict={}
        with open ('./dataCOPD/dict/'+'dataChartDic', 'rb') as fp:
...
def init(diag_flag,proc_flag,out_flag,chart_flag,med_flag,lab_flag):
        ...
        with open('./dataCOPD/dict/'+'ethVocabDict', 'wb') as fp:
            pickle.dump(ethVocabDict, fp)
            
        ageVocabDict=create_vocab('ageVocab')
        with open('./dataCOPD/dict/'+'ageVocabDict', 'wb') as fp:
            pickle.dump(ageVocabDict, fp)
        
        genderVocabDict=gender_vocab()
        with open('./dataCOPD/dict/'+'genderVocabDict', 'wb') as fp:
            pickle.dump(genderVocabDict, fp)
            
        insVocabDict=create_vocab('insVocab')
        with open('./dataCOPD/dict/'+'insVocabDict', 'wb') as fp:
...
def init_read(batch_size,diag_flag,proc_flag,out_flag,chart_flag,med_flag,lab_flag):
        ...
        with open('./dataCOPD/dict/'+'ethVocabDict', 'rb') as fp:
            ethVocabDict= pickle.load(fp)

        with open('./dataCOPD/dict/'+'ageVocabDict', 'rb') as fp:
            ageVocabDict= pickle.load(fp)

        with open('./dataCOPD/dict/'+'genderVocabDict', 'rb') as fp:
            genderVocabDict= pickle.load(fp)
            
        with open('./dataCOPD/dict/'+'insVocabDict', 'rb') as fp:
...
def get_meta():
    with open ('./dataCOPD/dict/'+'metaDic', 'rb') as fp:
        meta = pickle.load(fp)
    if "Lab" in meta.keys():
...
def get_batches():
    with open ('./dataCOPD/dict/'+'batchDict', 'rb') as fp:
...
def get_batch_data(key,data,diag_flag,proc_flag,out_flag,chart_flag,med_flag,lab_flag): 
    ...
    with open ('./dataCOPD/dict/'+'metaDic', 'rb') as fp:
        meta = pickle.load(fp)
    if diag_flag:
        with open ('./dataCOPD/dict/'+'condVocabDict', 'rb') as fp:
            condVocabDict = pickle.load(fp)
    if proc_flag:
        with open ('./dataCOPD/dict/'+'procVocabDict', 'rb') as fp:
            procVocabDict = pickle.load(fp)
    if med_flag:
        with open ('./dataCOPD/dict/'+'medVocabDict', 'rb') as fp:
            medVocabDict = pickle.load(fp)
    if out_flag:
        with open ('./dataCOPD/dict/'+'outVocabDict', 'rb') as fp:
            outVocabDict = pickle.load(fp)
    if lab_flag:
        with open ('./dataCOPD/dict/'+'labVocabDict', 'rb') as fp:
            labVocabDict = pickle.load(fp)
    ...
    if chart_flag:
        with open ('./dataCOPD/dict/'+'chartVocabDict', 'rb') as fp:
            chartVocabDict = pickle.load(fp)
        with open ('./dataCOPD/dict/'+'batchChartDict', 'rb') as fp:
