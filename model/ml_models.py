...
class ML_models():
    ...
    def ml_train(self):
        ...
        for i in range(self.k_fold):
            ...
            concat_cols=[]
            if(self.concat):
                dyn=pd.read_csv('./dataHeart_Failure/csv/'+str(train_hids[0])+'/dynamic.csv',header=[0,1])
...
#             print("y_df",y_df.shape)
    ...
    def save_outputImp(self,labels,prob,logits,importance,features):
        ...
        imp_df.to_csv('./dataHeart_Failure/output/'+'feature_importance.csv', index=False)
