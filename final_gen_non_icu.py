...
def generate_patient_features_csv(cohort_output_name, root_dir="."):
    ...
    # Define Paths
    cohort_path = f"{root_dir}/dataCKD/cohort/{cohort_output_name}.csv.gz"
    # cohort_path = f"./dataCKD/cohort/{cohort_output_name}.csv"
    diag_path = f"{root_dir}/dataCKD/features/preproc_diag.csv.gz"
    proc_path = f"{root_dir}/dataCKD/features/preproc_proc.csv.gz"
    med_path = f"{root_dir}/dataCKD/features/preproc_med.csv.gz"
    lab_path = f"{root_dir}/dataCKD/features/preproc_labs.csv.gz"
    
    output_filename = f"{root_dir}/patient_features_CKD.csv"
